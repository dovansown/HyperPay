  ...
  return (
    <div className="max-w-[1300px] mx-auto space-y-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            <h2 className="text-4xl font-black tracking-tight text-[#1d1a0c] dark:text-white">
              Security &amp; Audit Logs
            </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white dark:bg-[#2d2a15] p-6 rounded-xl border border-[#eae5cd] dark:border-[#3d3a25] flex flex-col gap-2">
            ...
            <p className="text-3xl font-black text-[#1d1a0c] dark:text-white">1,284</p>
          ...
          <div className="bg-white dark:bg-[#2d2a15] p-6 rounded-xl border border-[#eae5cd] dark:border-[#3d3a25] flex flex-col gap-2">
            ...
            <p className="text-3xl font-black text-[#1d1a0c] dark:text-white">12</p>
          ...
          <div className="bg-white dark:bg-[#2d2a15] p-6 rounded-xl border border-[#eae5cd] dark:border-[#3d3a25] flex flex-col gap-2">
            ...
            <p className="text-3xl font-black text-[#1d1a0c] dark:text-white">4</p>
        ...
        <div className="relative ml-5">
            ...
            <div className="bg-white dark:bg-[#2d2a15] p-5 rounded-2xl border-2 border-red-500/20 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div className="flex flex-col gap-1">
                <div className="flex items-center gap-2">
                  <h4 className="font-bold text-lg text-[#1d1a0c] dark:text-white">
          ...
          <div className="relative pl-12 pb-10">
            <div className="absolute left-0 top-0 size-10 rounded-full bg-primary/20 flex items-center justify-center border-4 border-background-light dark:border-background-dark z-10">
              <span className="material-symbols-outlined text-[#1d1a0c] text-xl">
                login
              </span>
            </div>
