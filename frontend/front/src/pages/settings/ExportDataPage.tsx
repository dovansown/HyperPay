    ...
    <div className="max-w-[1300px] mx-auto">
      <div className="flex flex-wrap justify-between items-end gap-3 p-4 mb-6">
        <div className="flex min-w-72 flex-col gap-2">
          <h1 className="text-[#181711] dark:text-white text-4xl font-black leading-tight tracking-[-0.033em]">
            Data Export &amp; Reports
          </h1>
          <p className="text-[#898361] dark:text-[#a6a086] text-base font-medium">
        ...
        <div className="flex gap-3">
          <button className="flex h-10 items-center justify-center rounded-full border border-[#181711]/10 dark:border-white/10 bg-white dark:bg-[#1c1a0e] px-4 text-sm font-bold">
            <span className="material-symbols-outlined text-lg mr-2">history</span> View
            History
          </button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-8 flex flex-col gap-8">
          <div className="bg-white dark:bg-[#1c1a0e] rounded-xl p-6 shadow-sm border border-[#181711]/5 dark:border-white/5">
          ...
          <div className="bg-white dark:bg-[#1c1a0e] rounded-xl p-6 shadow-sm border border-[#181711]/5 dark:border-white/5">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h2 className="text-xl font-bold">Filter by Bank &amp; Status</h2>
            </div>
            <div className="flex flex-col gap-6">
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <button className="flex items-center gap-2 px-4 py-2 rounded-full border border-[#181711]/10 dark:border-white/10 hover:border-primary text-sm font-medium">
                    <span className="material-symbols-outlined text-lg">add</span> More
                  </button>
                </div>
              </div>
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <div className="px-4 py-2 rounded-full border border-[#181711]/10 dark:border-white/10 text-sm font-medium flex items-center gap-2">
                    <span className="material-symbols-outlined text-lg">cancel</span> Failed
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="lg:col-span-4 flex flex-col gap-8">
          <div className="bg-white dark:bg-[#1c1a0e] rounded-xl p-6 shadow-sm border border-[#181711]/5 dark:border-white/5">
            <h3 className="font-bold text-lg mb-4">Export Format</h3>
            ...
            <button className="w-full mt-6 bg-primary hover:bg-primary/90 text-black font-black py-4 rounded-full shadow-lg transition-transform active:scale-95 text-lg">
              Generate Report
            </button>
          </div>

          <div className="bg-[#181711] text-white rounded-xl p-8 flex flex-col items-center text-center">
            <div className="mb-4 relative">
              <div className="size-20 bg-primary/20 rounded-full flex items-center justify-center text-5xl">
                🍳
              </div>
      ...
      <div className="fixed bottom-10 right-10 hidden lg:flex items-center gap-4 bg-white dark:bg-[#1c1a0e] p-4 rounded-xl shadow-2xl border border-primary/20">
        <div className="size-12 bg-primary rounded-full flex items-center justify-center text-2xl shadow-inner">
          ✨
        </div>
        <div>
